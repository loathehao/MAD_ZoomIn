        ...
        movieBmobQuery.findObjects(new FindListener<Movie>() {
            ...
            public void done(List<Movie> list, BmobException e) {
                    if (e == null) {
                        ...
                        Glide.with(Test.this).load(list.get(0).getPosterUrl()).error(R.drawable.my)
