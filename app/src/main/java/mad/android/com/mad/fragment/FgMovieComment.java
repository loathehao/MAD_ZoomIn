...
import mad.android.com.mad.adapter.ItemCommentAdapter;
...
public class FgMovieComment extends Fragment implements IMoviesView {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        itemCommentAdapter = new ItemCommentAdapter(getActivity());
    ...
    public void showNews(MoviesBean moviesBean) {
        itemCommentAdapter.setData(moviesBean.getSubjects());
        rv_comment.setLayoutManager(new LinearLayoutManager(getActivity()));
        rv_comment.setAdapter(itemCommentAdapter);
