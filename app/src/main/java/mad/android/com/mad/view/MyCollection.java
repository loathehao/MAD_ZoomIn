...
public class MyCollection extends Activity {
    ...
    private void initViews() {
        ...
        titleCenterTv.setText("我的收藏");
    }

    private void queryData() {
        BmobQuery<Movie> movieBmobQuery = new BmobQuery<>();
        movieBmobQuery.addWhereEqualTo("favorite",true);
        ...
        movieBmobQuery.findObjects(new FindListener<Movie>() {
            ...
            public void done(List<Movie> list, BmobException e) {
                if (e == null) {
                    ...
                    Glide.with(MyCollection.this).load(list.get(0).getPosterUrl()).error(R.drawable.my)
                    ...
                    Glide.with(MyCollection.this).load(list.get(1).getPosterUrl()).error(R.drawable.my)
                            .centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL)
                            .into(like_movie_pic2);
                    like_movie_introduce2.setText(list.get(1).getCasts());

                    like_movie_name3.setText(list.get(2).getTitle());
                    Glide.with(MyCollection.this).load(list.get(2).getPosterUrl()).error(R.drawable.my)
                            .centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL)
                            .into(like_movie_pic3);
                    like_movie_introduce3.setText(list.get(2).getCasts());

                    like_movie_name4.setText(list.get(3).getTitle());
                    Glide.with(MyCollection.this).load(list.get(3).getPosterUrl()).error(R.drawable.my)
                            .centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL)
